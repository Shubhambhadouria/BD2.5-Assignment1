...
app.get('/products/filter/brand', (req, res) => {
  ...
  let sortedProducts = products.filter((data) => filterByBrand(data, brand));
  res.json({ products: sortedProducts });
});
...
app.get('/products/filter/os', (req, res) => {
  let os = req.query.os;
  let sortedProducts = products.filter((data) => filterByOs(data, os));
  res.json({ products: sortedProducts });
});
...
app.get('/products/filter/price', (req, res) => {
  ...
  let sortedProducts = products.filter((data) => filterByPrice(data, price));
  res.json({ products: sortedProducts });
});
